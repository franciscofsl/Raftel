...
namespace Raftel.Demo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260620073114_Add_EntityChangeAudit")]
    partial class Add_EntityChangeAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raftel.Domain.Auditing.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raftel.Domain.Auditing.EntityChange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EntityFullName", "EntityId");

                    b.ToTable("EntityChange");
                });

            modelBuilder.Entity("Raftel.Domain.Auditing.PropertyChange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raftel.Domain.Features.Authorization.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raftel.Domain.Features.Authorization.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raftel.Domain.Features.Tenants.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raftel.Domain.Features.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("Raftel.Domain.Features.Authorization.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Raftel.Domain.Features.Authorization.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Raftel.Domain.Auditing.EntityChange", b =>
                {
                    b.HasOne("Raftel.Domain.Auditing.AuditLog", null)
            ...
            modelBuilder.Entity("Raftel.Domain.Auditing.PropertyChange", b =>
                {
                    b.HasOne("Raftel.Domain.Auditing.EntityChange", null)
                        .WithMany("AffectedProperties")
            ...
            modelBuilder.Entity("Raftel.Domain.Auditing.EntityChange", b =>
                {
                    b.Navigation("AffectedProperties");
                });
