...
public class PostgreSqlEfRepositoryTests : PostgreSqlInfrastructureTestBase
{
    ...
    [Fact]
    public async Task ListAllAsync_ShouldRetrieveExpectedData_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task Update_ShouldModifyEntityCorrectly_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task Remove_ShouldDeleteEntity_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task Remove_ShouldDeleteEntity_WithSoftDelete_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task Remove_ShouldSetIsDeletedTrue_WhenEntityIsSoftDeleted_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task GetByIdAsync_ShouldReturnAggregateWithChildEntities_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
    ...
    [Fact]
    public async Task AddAsync_ShouldPersistMultipleEntities_WithPostgreSql()
    {
        await ExecuteScopedAsync(async sp =>
        {
            var unitOfWork = sp.GetRequiredService<IUnitOfWork>();
