...
/// <summary>
/// Marker interface used to identify the tenant filter in the data filtering system.
/// </summary>
/// <remarks>
/// This interface has no members and is used exclusively as a type token to represent the
/// tenant filter when enabling or disabling it at runtime via <see cref="IDataFilter"/>.
/// </remarks>
[Marker]
